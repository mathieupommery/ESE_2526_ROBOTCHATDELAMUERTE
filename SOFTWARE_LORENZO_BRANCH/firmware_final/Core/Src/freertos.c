...
void Startmaintask(void const * argument)
{
	...
	//	int i=0;						//everything commented is to test the motors
	/* Infinite loop */
	for(;;)
	{
		//	  switch(i){
