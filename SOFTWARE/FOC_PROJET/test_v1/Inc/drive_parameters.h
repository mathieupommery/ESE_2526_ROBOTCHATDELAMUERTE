...
#define PID_TORQUE_KP_DEFAULT               2839
#define PID_TORQUE_KI_DEFAULT               2839
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2839
#define PID_FLUX_KI_DEFAULT                 2839
...
#define PID_SPEED_KP_DEFAULT                3249/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                84/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define  M1_TEMP_SAMPLING_TIME              LL_ADC_SAMPLING_CYCLE(79)
