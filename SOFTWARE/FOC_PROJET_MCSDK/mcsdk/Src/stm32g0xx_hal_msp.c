...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = M1_BUS_VOLTAGE_Pin|M1_TEMPERATURE_Pin|M1_CURR_AMPL_U_Pin|M1_CURR_AMPL_V_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, M1_BUS_VOLTAGE_Pin|M1_TEMPERATURE_Pin|M1_CURR_AMPL_U_Pin|M1_CURR_AMPL_V_Pin);
